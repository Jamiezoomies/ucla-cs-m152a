...
HD_PWD='C:/Users/Student/Desktop/Brad_Tae/flappy_bird/flappy_bird.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log game_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source game_controller.tcl
