...
HD_PWD='C:/Users/Student/Desktop/Brad_Tae/flappy_bird/flappy_bird.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log game_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source game_controller.tcl -notrace
